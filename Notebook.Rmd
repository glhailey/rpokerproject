...
scoreStraightRanker <- function(oneHand)  {
  ...
  rankValues <- run$values
	...
	if(sum(rankValues==14) > 0){
	  rankValues <- append(rankValues,14)
...
customRoundOfPoker <- function(customRankFunctions, wildCardNumber) {
...
customRoundOfPoker(list(scoreHighCard, scorePairRanker, scoreTwoPairRanker, scoreTripRanker,  scoreStraightRanker, scoreFlushRanker, scoreFullHouseRanker, scoreQuadRanker),0)

# Default game of poker with 4 wildcards
customRoundOfPoker(list(scoreHighCard, scorePairRanker, scoreTwoPairRanker, scoreTripRanker,  scoreStraightRanker, scoreFlushRanker, scoreFullHouseRanker, scoreQuadRanker),4)

# Game of poker with no pairs
customRoundOfPoker(list(scoreHighCard, scoreTripRanker ,scoreQuadRanker, scoreStraightRanker ,scoreFullHouseRanker, scoreFlushRanker),4)
...
```
  ...
  ```{r}
customRoundOfPoker(normalPokerHands)
